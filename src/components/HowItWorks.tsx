          ...
          {steps.map((item, index) => (
            <div key={index} className="relative text-center group">
              ...
              {index < steps.length - 1 && (
                <div className="hidden md:block absolute top-12 left-[60%] w-[80%] h-0.5 bg-gray-200 dark:bg-gray-700" />
              )}

              <div className="relative inline-flex items-center justify-center w-24 h-24 bg-white dark:bg-gray-700 rounded-2xl shadow-lg group-hover:shadow-xl transition-shadow duration-300 mb-6">
